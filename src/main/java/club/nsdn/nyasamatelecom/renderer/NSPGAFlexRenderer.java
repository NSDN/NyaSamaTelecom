 ...
 */
public class NSPGAFlexRenderer extends AbsTileEntitySpecialRenderer {
    ...
    public void render(@Nonnull TileEntityBase te, double x, double y, double z, float partialTicks, int destroyStage, float partial) {
        int meta = te.META;
        if (!(te.getBlockType() instanceof BlockNSPGAFlex)) return;
        BlockNSPGAFlex block = (BlockNSPGAFlex) te.getBlockType();
